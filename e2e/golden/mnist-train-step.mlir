module @leanax_mnist_train_step {
  func.func @main(%x: tensor<2x784xf32>, %labels: tensor<2x10xf32>, %relu_mask: tensor<2x8xf32>, %w1: tensor<784x8xf32>, %b1: tensor<8xf32>, %w2: tensor<8x10xf32>, %b2: tensor<10xf32>) -> (tensor<784x8xf32>, tensor<8xf32>, tensor<8x10xf32>, tensor<10xf32>, tensor<f32>) {
    ...
    %hidden = "stablehlo.maximum"(%hidden_pre, %relu_zero_batched) : (tensor<2x8xf32>, tensor<2x8xf32>) -> tensor<2x8xf32>
    %logits_linear = "stablehlo.dot_general"(%hidden, %w2) {batching_dims = "[] x []"} : (tensor<2x8xf32>, tensor<8x10xf32>) -> tensor<2x10xf32>
